...
#[AsController]
final readonly class PhaseCanActivateController
{
    ...
    #[Route('/api/phases/can-activate', name: 'api_phases_can_activate', methods: ['GET'])]
    public function __invoke(Request $request): JsonResponse
    {
        ...
        return new JsonResponse([
            'canActivate' => $this->competitionState->canActivate($type, $group),
        ]);
    }
}
